...
//	    	System.out.println(ScheduledFlights.getScheduledFlights());
		       System.out.println("Date and Time of Departure: "+ScheduledFlights.getScheduledFlights().get(i).getDepartureTime());
...
//		 	   System.out.println("Weather Zone: " +ScheduledFlights.getScheduledFlights().get(i).getdepartureAirport().getWeatherZone());
		 	   ...
		 	   System.out.println("Date and Time of Arrival: "+ScheduledFlights.getScheduledFlights().get(i).getArrivalTime());
